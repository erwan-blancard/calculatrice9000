...
calc_field = Entry(main_frame, width=384, justify=CENTER, font=('Arial', 20))
...
# n0 = Button(button_frame, text="0", borderwidth=7, command=lambda:click("0")).grid(row=2, column=6)

equB = Button(button_frame, text="=", width=7, height=2, command=lambda:process_statement()).grid(row=6, column=4, pady=3, padx=3)
...
powB = Button(button_frame, text="x²", width=7, height=2, command=lambda:click("**2")).grid(row=2, column=2, pady=3, padx=3)
...
clearB = Button(button_frame, text="CE", width=24, height=2, command=lambda:clear_statement()).grid(row=1, column=2, columnspan=3, pady=3, padx=3)
